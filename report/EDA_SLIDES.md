...
style: |
  ...
  h2 {
    background-color: #7efaff !important;
    color: #000 !important;
...
1. **상권 양극화**: 강남/역삼 등 핵심 상권의 프라임 매물이 가격을 견인.
2. **무권리 매물 급증**: 데이터의 절반 이상이 무권리. 소자본 창업 기회.
3. **입지 편중**: 강남역, 역삼역 인근에 매물이 고도로 집중.
...
![w:600](../images/cat_freq_1.png)

- **기기타업종**(325건), **일반음식점**(96건) 순.
...
![w:500](../images/tfidf_keywords.png)

- **주요 키워드**: 역삼동, 강남역, 인테리어, 무권리.
- '입지'와 '즉시 영업 가능성'을 최우선으로 고려함.
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
  <img src="../images/viz_1.png" width="300">
  <img src="../images/viz_2.png" width="300">
</div>

- **Right-Skewed**: 대다수는 저렴하나 일부 프라임 매물이 평균을 높임.
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
  <img src="../images/viz_3.png" width="300">
  <img src="../images/viz_8.png" width="300">
</div>

- **1층 프리미엄**: 1층의 월세가 압도적으로 높음.
- 목적형 업종은 2층 이상으로 진입하여 고정비 절감.
...
<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
  <img src="../images/viz_4.png" width="300">
  <img src="../images/viz_5.png" width="300">
</div>

- 회귀선 하단 매물을 공략하여 효율적 공간 확보 가능.
...
![w:600](../images/viz_9.png)

- **조회수 vs 관심도**: 가성비+시설 완비 매물에 찜(Favorite) 집중.
...
1. **데이터 기반 입지 선정**: 중앙값(Median)을 활용한 정밀한 프라이싱.
2. **전략적 출점**: 업종 특성에 맞는 층수 선택으로 ROI 극대화.
3. **리스크 관리**: 무권리 매물의 함정을 피하고 검증된 상권 선별.
